...
class BattlesInGameTest extends TestCase
{
    ...
    {
        return [
            'test battle 1x1' => self::prepareDataFor1x1(),
            'test battle 2x2' => self::prepareDataFor2x2(),
        ];
    }

    private static function prepareDataFor1x1(): array
    {
    ...
    private static function prepareDataFor2x2(): array
    {
        SingletonsContainer::instance()->cleanContainer();
