...
use Galaktika\Various\Seminars\VeryGood\ApiClient;
use Galaktika\Various\Seminars\VeryGood\Controller;
use Galaktika\Various\Seminars\VeryGood\Product;
use Galaktika\Various\Seminars\VeryGood\Repository;
...
class VeryGoodTest extends TestCase
{
    ...
    public function testVeryGood2()
    {
        ...
        $products = $controller->getProducts2(new Request('get', '/api', [], 'cosmetics'));
